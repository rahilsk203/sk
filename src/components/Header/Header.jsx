        ...
        <div className="header">
            <div className="logo">
                <svg width="70" height="70" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="50" cy="50" r="45" fill="#14E956" stroke="#1E2128" strokeWidth="10"/>
                    <text x="50" y="60" textAnchor="middle" fill="#1E2128" fontSize="30" fontWeight="bold">SK</text>
                </svg>
            </div>
            ...
            <div className="menu-toggle">
                ...
                <div className="navigation">
                    <div className="large_menu">
                        <a className="github" href="https://github.com/sksohel3" target="_blank" rel="noopener noreferrer">
                        ...
                        <a className="linkedin" href="https://www.linkedin.com/in/sk-sohel" target="_blank" rel="noopener noreferrer">
                        ...
                        <a className="twitter" href="https://twitter.com/sk_sohel_dev" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="small_menu">
                        <ul>
                            <li className="menu-one">
                                <a className="nav-link" onClick={check} href="#home">
                                    <span className="menu-point-icon">
                                        <svg viewBox="0 0 16 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3 4V16L6 13L8.5 18C8.5 18 9.17631 18.2158 9.5 18C9.82369 17.7842 10.1457 17.3496 10 17C9.31233 15.3496 7.5 12 7.5 12H11L3 4Z" fill="#14E956"/>
                                        </svg>
                                    </span>
                                    Home
                                </a>
                            ...
                            <li className="menu-two">
                                <a className="nav-link" onClick={check} href="#work">
                                    <span className="menu-point-icon">
                                        <svg viewBox="0 0 16 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3 4V16L6 13L8.5 18C8.5 18 9.17631 18.2158 9.5 18C9.82369 17.7842 10.1457 17.3496 10 17C9.31233 15.3496 7.5 12 7.5 12H11L3 4Z" fill="#14E956"/>
                                        </svg>
                            ...
                            <li className="menu-three">
                                <a className="nav-link" href="https://dev.to/sksohel" target="_blank" rel="noopener noreferrer">
                                    <span className="menu-point-icon">
                                        <svg viewBox="0 0 16 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3 4V16L6 13L8.5 18C8.5 18 9.17631 18.2158 9.5 18C9.82369 17.7842 10.1457 17.3496 10 17C9.31233 15.3496 7.5 12 7.5 12H11L3 4Z" fill="#14E956"/>
                                        </svg>
                            ...
                            <li className="menu-four">
                                <a className="nav-link" href="https://drive.google.com/file/d/your-resume-id/view" target="_blank" rel="noopener noreferrer">
                                    <span className="menu-point-icon">
                                        <svg viewBox="0 0 16 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3 4V16L6 13L8.5 18C8.5 18 9.17631 18.2158 9.5 18C9.82369 17.7842 10.1457 17.3496 10 17C9.31233 15.3496 7.5 12 7.5 12H11L3 4Z" fill="#14E956"/>
                                        </svg>
                            ...
                            <li className="menu-five">
                                <a className="nav-link" href="mailto:contact@sksohel.dev" target="_blank" rel="noopener noreferrer">
                                    <span className="menu-point-icon">
                                        <svg viewBox="0 0 16 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3 4V16L6 13L8.5 18C8.5 18 9.17631 18.2158 9.5 18C9.82369 17.7842 10.1457 17.3496 10 17C9.31233 15.3496 7.5 12 7.5 12H11L3 4Z" fill="#14E956"/>
                                        </svg>

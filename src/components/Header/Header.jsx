        ...
        <div className="header">
            <div className="logo">
                <svg width="70" height="70" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <text x="50" y="60" textAnchor="middle" fill="#1E2128" fontSize="30" fontWeight="bold">O</text>
                </svg>
            </div>
            ...
            <div className="menu-toggle">
                ...
                <div className="navigation">
                    <div className="large_menu">
                        <a className="github" href="https://github.com/kasodon" target="_blank" rel="noopener noreferrer">
                        ...
                        <a className="linkedin" href="https://www.linkedin.com/in/edewor-onyedika/" target="_blank" rel="noopener noreferrer">
                        ...
                        <a className="twitter" href="https://twitter.com/web3_overlord" target="_blank" rel="noopener noreferrer">
                        ...
                        <a className="schedule" href="https://calendly.com/edeworonyedika" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="small_menu">
                        <ul>
                            <li className="menu-one">
                                <a className="nav-link" onClick={check} href="#home">Home</a>
                            </li>
                            <li className="menu-two">
                                <a className="nav-link" onClick={check} href="#work">Work</a>
                            </li>
                            <li className="menu-three">
                                <a className="nav-link" href="https://hackernoon.com/u/onyedika" target="_blank" rel="noopener noreferrer">Writing</a>
                            </li>
                            <li className="menu-four">
                                <a className="nav-link" href="https://drive.google.com/file/d/1mvp127VmxH5b68onmg0gKmxF6DZTIPUE/view?usp=sharing" target="_blank" rel="noopener noreferrer">Resume</a>
                            </li>
                            <li className="menu-five">
                                <a className="nav-link" href="mailto:edeworonyedika@gmail.com" target="_blank" rel="noopener noreferrer">Contact</a>
                            </li>
                        </ul>
                    </div>
                </div>
